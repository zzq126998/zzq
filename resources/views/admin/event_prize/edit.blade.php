...
@section("content")
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{$even->name}}" class="form-control" placeholder="请输入奖品名称" name="name">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <!-- 编辑器容器 -->
                <script id="container" name="description" type="text/plain">{!! $even->description !!}</script>
            </div>
        </div>
        <div class="form-group">
