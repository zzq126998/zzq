...
@section("content")
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date" value="{{old('prize_time')}}" class="form-control" placeholder="请输入活动开奖"
                       name="prize_time">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{old('num')}}" class="form-control" placeholder="请输入报名人数" name="num">
            </div>
        </div>
        <div class="form-group">
