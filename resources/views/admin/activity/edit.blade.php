...
@section("content")
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{$act->title}}" class="form-control" placeholder="请输入活动名称"
                       name="title">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date" value="{{date('Y-m-d',$act->start_time)}}" class="form-control" placeholder="请输入活动开始时间"
                       name="start_time">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date" value="{{date('Y-m-d',$act->end_time)}}" class="form-control" placeholder="请输入活动结束时间"
                       name="end_time">
            </div>
        </div>
        {{--<div class="form-group">--}}
