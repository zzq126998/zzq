        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><input type="shop_rating" name="shop_rating" class="col-sm-5 form-control" placeholder="商家评分"><br><br></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="0.00" name="start_send" class="col-sm-5 form-control" placeholder="起送金额"></td>
                </tr>
                <tr>
                    <td style="text-align: right; width: 20%">配送费</td>
                    <td><input type="text" value="0.00" name="start_cost" class="col-sm-5 form-control" placeholder="配送费"></td>
                </tr>
                <tr>
